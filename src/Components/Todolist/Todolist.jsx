...
const TodoList = () => {
  const { todos, handleAddTodo, handleDeleteTodo, handleToggleComplete, completedCount } = useTodos();
            ...
            {({ handleSubmit, handleChange, values }) => (
              <Form inline="true" className="d-flex mb-3 form-style" onSubmit={handleSubmit}>
                <div className="d-flex flex-column">
                  ...
                  />
                  <ErrorMessage name="task" component="div" className="text-danger mx-2 error" />
                </div>
          ...
          <div className="list-container">
            <ListGroup>
              ...
              <div className="taskinfo">
                <p className="my-1">
                  <span className="total">تعداد وظایف</span> <span>:{todos.length}</span>
                </p>
                <p className="my-3">
                  <span className="done ">کار های انجام شده</span> <span>:{completedCount}</span>
                </p>
              </div>
            </ListGroup>
          </div>
